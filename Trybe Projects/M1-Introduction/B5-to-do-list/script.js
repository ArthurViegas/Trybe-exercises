...
let selected = '';
  ...
  for (let i = 0; i < items.length; i++) {
    ...
    let selectedClass = selected.className;

    let previousText = '';
    let previousClass = '';

     if (previous){
       previousText = previous.innerHTML
       previousClass = previous.className
     }
     let itemBelowText = previousText;
     let itemBelowClass = previousClass;
     let itemTopText = selectedText;
     let itemTopClass = selectedClass;
